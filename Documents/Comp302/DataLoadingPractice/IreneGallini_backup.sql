...
CREATE TABLE `course` (
  ...
  CONSTRAINT `course_ibfk_1` FOREIGN KEY (`department_code`) REFERENCES `department` (`code`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
('BIOL',190,'Genetics','BIO'),
('COMP',302,'Introduction to DBMS','MSCS');
...
('BIO','Biology',1),
('MSCS','Math, Stats and Computer Science',1);
...
CREATE TABLE `enrollment` (
  ...
  `section_course_number` int(11) NOT NULL,
  `section_number` int(11) NOT NULL,
  `section_semester` varchar(50) NOT NULL,
  ...
  KEY `section_course_code` (`section_course_code`,`section_course_number`,`section_number`,`section_semester`,`section_year`),
  CONSTRAINT `enrollment_ibfk_1` FOREIGN KEY (`student_id`) REFERENCES `student` (`ID`),
  CONSTRAINT `enrollment_ibfk_2` FOREIGN KEY (`section_course_code`, `section_course_number`, `section_number`, `section_semester`, `section_year`) REFERENCES `section` (`course_code`, `course_number`, `number`, `semester`, `year`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
(10001,'COMP',302,1,'Spring',2026,'A-'),
(10002,'COMP',302,1,'Spring',2026,'C-'),
(10003,'BIOL',190,1,'Spring',2026,'B+'),
(20001,'COMP',302,2,'Spring',2026,'C+'),
(20002,'COMP',302,2,'Spring',2026,'B-'),
(30001,'BIOL',190,1,'Spring',2026,'A-'),
(30002,'BIOL',190,1,'Spring',2026,'A-'),
(40001,'BIOL',190,1,'Spring',2026,'A-');
...
CREATE TABLE `raw_data` (
  ...
  `section_semester` varchar(50) DEFAULT NULL,
...
(1,'Macalester','MSCS','Math, Stats and Computer Science','COMP',302,'Introduction to DBMS',1,'Spring',2026,10001,'George','Washington','Washington Carver',2026,'A-'),
(1,'Macalester','MSCS','Math, Stats and Computer Science','COMP',302,'Introduction to DBMS',1,'Spring',2026,10002,'Benjamin','','Banneker',2026,'C-'),
(1,'Macalester','MSCS','Math, Stats and Computer Science','COMP',302,'Introduction to DBMS',2,'Spring',2026,20001,'Patricia','','Selinger',2027,'C+'),
(1,'Macalester','MSCS','Math, Stats and Computer Science','COMP',302,'Introduction to DBMS',2,'Spring',2026,20002,'Edgar','E.F. ','Codd',2027,'B-'),
(1,'Macalester','BIO','Biology','BIOL',190,'Genetics',1,'Spring',2026,30001,'Madame','C.J.','Walker',2028,'A-'),
(1,'Macalester','BIO','Biology','BIOL',190,'Genetics',1,'Spring',2026,40001,'Ellen','Johnson','Sirleaf',2029,'A-'),
(1,'Macalester','BIO','Biology','BIOL',190,'Genetics',1,'Spring',2026,30002,'Condoleezza','','Rice',2028,'A-'),
(1,'Macalester','BIO','Biology','BIOL',190,'Genetics',1,'Spring',2026,10003,'Madeleine','','Albright',2026,'B+');
...
CREATE TABLE `section` (
  ...
  CONSTRAINT `section_ibfk_1` FOREIGN KEY (`course_code`, `course_number`) REFERENCES `course` (`code`, `number`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
('BIOL',190,1,'Spring',2026),
('COMP',302,1,'Spring',2026),
('COMP',302,2,'Spring',2026);
...
/*!40000 ALTER TABLE `student` DISABLE KEYS */;
INSERT INTO `student` VALUES
(10001,'George','Washington','Washington Carver',2026),
(10002,'Benjamin','','Banneker',2026),
(10003,'Madeleine','','Albright',2026),
(20001,'Patricia','','Selinger',2027),
(20002,'Edgar','E.F. ','Codd',2027),
(30001,'Madame','C.J.','Walker',2028),
(30002,'Condoleezza','','Rice',2028),
(40001,'Ellen','Johnson','Sirleaf',2029);
/*!40000 ALTER TABLE `student` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2026-03-12  0:40:22
