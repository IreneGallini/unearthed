...
reside_townId VARCHAR(3), 
idol_creatureId     INTEGER,
FOREIGN KEY(reside_townId) REFERENCES town(townId),     -- foreign key
FOREIGN KEY(idol_creatureId) REFERENCES creature(creatureId)
)ENGINE=InnoDB;

INSERT INTO creature(creatureId,creatureName,creatureType,reside_townId) VALUES (1,'Bannon','person','p');
INSERT INTO creature(creatureId,creatureName,creatureType,reside_townId) VALUES (2,'Myers','person','a');
INSERT INTO creature(creatureId,creatureName,creatureType,reside_townId) VALUES (3,'Neff','person','be');
INSERT INTO creature(creatureId,creatureName,creatureType,reside_townId) VALUES (4,'Neff','person','b');
INSERT INTO creature(creatureId,creatureName,creatureType,reside_townId) VALUES (5,'Mieska','person','d');
INSERT INTO creature(creatureId,creatureName,creatureType,reside_townId) VALUES (6,'Carlis','person','p');
INSERT INTO creature(creatureId,creatureName,creatureType,reside_townId) VALUES (7,'Kermit','frog','g');
INSERT INTO creature(creatureId,creatureName,creatureType,reside_townId) VALUES (8,'Godzilla','monster','t');
INSERT INTO creature(creatureId,creatureName,creatureType,reside_townId) VALUES (9,'Thor','superhero','as');
INSERT INTO creature(creatureId,creatureName,creatureType,reside_townId) VALUES (10,'Elastigirl','superhero','mv');
INSERT INTO creature(creatureId,creatureName,creatureType,reside_townId) VALUES (11,'David Beckham','person','le');
INSERT INTO creature(creatureId,creatureName,creatureType,reside_townId) VALUES (12,'Harry Kane','person','le');
INSERT INTO creature(creatureId,creatureName,creatureType,reside_townId) VALUES (13,'Megan Rapinoe','person','sw');

UPDATE creature SET idol_creatureId=10 WHERE creatureId=1;
UPDATE creature SET idol_creatureId=9 WHERE creatureId=2;
UPDATE creature SET idol_creatureId=3 WHERE creatureId=4;
UPDATE creature SET idol_creatureId=10 WHERE creatureId=5;
UPDATE creature SET idol_creatureId=9 WHERE creatureId=6;
UPDATE creature SET idol_creatureId=8 WHERE creatureId=7;
UPDATE creature SET idol_creatureId=6 WHERE creatureId=8;
UPDATE creature SET idol_creatureId=13 WHERE creatureId=10;
UPDATE creature SET idol_creatureId=9 WHERE creatureId=11;
UPDATE creature SET idol_creatureId=11 WHERE creatureId=12;
UPDATE creature SET idol_creatureId=10 WHERE creatureId=13;
...
origin_townId      VARCHAR(3),
FOREIGN KEY (origin_townId) REFERENCES town(townId)    
)ENGINE=InnoDB;
...
achId              INTEGER NOT NUll PRIMARY KEY AUTO_INCREMENT,
creatureId         INTEGER,
skillCode          VARCHAR(3),
proficiency        INTEGER,
achDate            DATETIME,
test_townId VARCHAR(3),
FOREIGN KEY (creatureId) REFERENCES creature (creatureId),
FOREIGN KEY (skillCode) REFERENCES skill (skillCode),
FOREIGN KEY (test_townId) REFERENCES town(townId)
)ENGINE=InnoDB;

-- Bannon floats in Anoka (where he aspired)
INSERT INTO achievement (creatureId, skillCode, proficiency,achDate, test_townId) VALUES (1, 'A', 3, now(), 'a');
-- Bannon swims in Duluth (he aspired in Bemidji)
INSERT INTO achievement (creatureId, skillCode, proficiency,achDate, test_townId) VALUES (1, 'E', 3, '2017-09-15 15:35', 'd');
-- Bannon floats in Anoka (where he aspired)
INSERT INTO achievement (creatureId, skillCode, proficiency,achDate, test_townId) VALUES (1, 'A', 3, '2018-07-14 14:00', 'a');
-- Bannon swims in Duluth (he aspired in Bemidji)
INSERT INTO achievement (creatureId, skillCode, proficiency,achDate, test_townId) VALUES (1, 'E', 3, now(), 'd');
-- Bannon doesn't gargle
-- Mieska gargles in Tokyo (had no aspiration to)
INSERT INTO achievement (creatureId, skillCode, proficiency,achDate, test_townId) VALUES (5, 'Z', 6, '2016-04-12 15:42:30', 't');
-- Neff #3 gargles in Blue Earth (but not to his aspired proficiency)
INSERT INTO achievement (creatureId, skillCode, proficiency,achDate, test_townId) VALUES (3, 'Z', 4, '2018-07-15', 'be');
-- Neff #3 gargles in Blue Earth (but not to his aspired proficiency)
-- on same day at same proficiency, signifying need for arbitrary id
INSERT INTO achievement (creatureId, skillCode, proficiency,achDate, test_townId) VALUES (3, 'Z', 4, '2018-07-15', 'be');
-- Beckham achieves PK in London
INSERT INTO achievement (creatureId, skillCode, proficiency,achDate, test_townId) VALUES (11, 'PK', 10, '1998-08-15', 'le');
-- Kane achieves PK in London
INSERT INTO achievement (creatureId, skillCode, proficiency,achDate, test_townId) VALUES (12, 'PK', 10, '2016-05-24', 'le');
-- Rapinoe achieves PK in London
INSERT INTO achievement (creatureId, skillCode, proficiency,achDate, test_townId) VALUES (13, 'PK', 10, '2012-08-06', 'le');
-- Godizilla achieves PK in Tokyo poorly with no date
-- had not aspiration to do so- did it on a dare ;)
INSERT INTO achievement (creatureId, skillCode, proficiency,achDate, test_townId) VALUES (8, 'PK', 1, NULL, 't');

-- -------------------- -------------------- -------------------
-- Thor achieves three-legged race in Metroville (with Elastigirl)
INSERT INTO achievement (creatureId, skillCode, proficiency,achDate, test_townId) VALUES (9, 'THR', 10, '2018-08-12 14:30', 'mv');
-- Elastigirl achieves three-legged race in Metroville (with Thor)
INSERT INTO achievement (creatureId, skillCode, proficiency,achDate, test_townId) VALUES (10, 'THR', 10, '2018-08-12 14:30', 'mv');

-- Kermit 'pilots' 2-person bobsledding  (pilot goes into contribution)
--       with Thor as brakeman (brakeman goes into contribution) in Duluth,
--    achieve at 76% of maxProficiency
INSERT INTO achievement (creatureId, skillCode, proficiency,achDate, test_townId) VALUES (7, 'B2', 19, '2017-01-10 16:30', 'd');
INSERT INTO achievement (creatureId, skillCode, proficiency,achDate, test_townId) VALUES (9, 'B2', 19, '2017-01-10 16:30', 'd');

-- 4 people form track realy team in London:
--   Neff #4, Mieska, Myers, Bannon
--    achieve at 85% of maxProficiency
INSERT INTO achievement (creatureId, skillCode, proficiency,achDate, test_townId) VALUES (4, 'TR4', 85, '2012-07-30', 'le');
INSERT INTO achievement (creatureId, skillCode, proficiency,achDate, test_townId) VALUES (5, 'TR4', 85, '2012-07-30', 'le');
INSERT INTO achievement (creatureId, skillCode, proficiency,achDate, test_townId) VALUES (2, 'TR4', 85, '2012-07-30', 'le');
INSERT INTO achievement (creatureId, skillCode, proficiency,achDate, test_townId) VALUES (1, 'TR4', 85, '2012-07-30', 'le');

-- Thor, Rapinoe, and Kermit form debate team in Seattle, WA and
-- achieve at 80% of maxProficiency
INSERT INTO achievement (creatureId, skillCode, proficiency,achDate, test_townId) VALUES (9, 'D3', 8, LOCALTIME(), 'sw');
INSERT INTO achievement (creatureId, skillCode, proficiency,achDate, test_townId) VALUES (13, 'D3', 8, LOCALTIME(), 'sw');
INSERT INTO achievement (creatureId, skillCode, proficiency,achDate, test_townId)VALUES (7, 'D3', 8, LOCALTIME(), 'sw');
...
( 
  ...
  desired_townId     VARCHAR(3),
  FOREIGN KEY (creatureId) REFERENCES creature(creatureId), 
  FOREIGN KEY (skillCode)REFERENCES skill(skillCode), 
  FOREIGN KEY (desired_townId) REFERENCES town(townId),    
